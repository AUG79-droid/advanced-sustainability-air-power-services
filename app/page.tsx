...
export default function App() {
  ...
  return <div>
    ...
    <main id="main">
      ...
      {view === "resources" && <div className="wide"><PageHero eyebrow="Evidence resources" title="Toolkit, glossary and source library" copy="Reuse the decision canvases, check technical definitions and trace every public source supporting the course." code="39 sources" />
        <div className="tabs resource-tabs"><button className={resourceTab === "tools" ? "active" : ""} onClick={() => setResourceTab("tools")}>7 decision tools</button><button className={resourceTab === "refs" ? "active" : ""} onClick={() => setResourceTab("refs")}>Glossary & source library</button><button className={resourceTab === "files" ? "active" : ""} onClick={() => setResourceTab("files")}>Downloads</button></div>
