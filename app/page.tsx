...
const toolsByModule: Record<number, ToolConfig[]> = {
  ...
  6: [{ number: 6, title: "In-Service Roadmap", purpose: "Turn evidence-backed actions into an owned 24-month delivery plan.", outcome: "A governed action with baseline, KPI, milestones, risks and review trigger.",
    ...
    caseData: ["Orion must select four actions for a 24-month portfolio.", "Availability and mission requirements are mandatory gates.", "Every KPI needs owner, unit, boundary, frequency and source.", "A target is not a result and must not be communicated as one."],
    ...
    <main id="main">
      {view === "home" && <>
        <section className="hero">
          ...
          <div className="hero-graphic photo-frame"><img src="./images/hero-air-power.webp" alt="Air Power aircraft supported by maintenance and ground teams" /><div className="sequence"><i /> <span><small>The course mindset</small><b>Gate → Evidence → Optimise → Verify</b></span></div></div>
        </section>
        <section className="course-guide" aria-labelledby="course-guide-title">
          ...
          <div className="after-modules"><b>After module 6</b><span>Complete the Orion capstone → take the final assessment → unlock your certificate.</span></div>
        </section>
